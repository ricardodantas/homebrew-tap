class Hazelnut < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "d6d0fa63c3cda86c9779e6d1cd65ce43237154c8bece55ff354401efe85b973d"
    end
    on_intel do
      url "https://github.com/ricardodantas/hazelnut/releases/download/v#{version}/hazelnut-#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "c4ff5dc2288776d1647e6e2bbcafc59ac50a55b6399355c936d1fb1508ff2e4d"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "577822130c3135b154b5402f5d28861947ebaec0b61d10f42af021ca1947b7b9"
    end
    on_intel do
      url "https://github.com/ricardodantas/hazelnut/releases/download/v#{version}/hazelnut-#{version}-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "652989cf2111a0bd5d1b170c9c52e2a71bf76a64f0ab0c673770a4cb6df42ac4"
    end
  end
