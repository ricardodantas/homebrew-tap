class Feedo < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "c267f39790497128c6d016ce5cd1814bc9c44ffc45111ea9a9e643e3f9277239"
    end
    on_intel do
      url "https://github.com/ricardodantas/feedo/releases/download/v#{version}/feedo-#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "70e498b41910323a1916776d8a029ae3a00409a0d25abd40af2805cb6b4708fa"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "e28f2977ab1f5d41f1dadef87d9936d08b1c052053218d7b143020f83db8abdd"
    end
    on_intel do
      url "https://github.com/ricardodantas/feedo/releases/download/v#{version}/feedo-#{version}-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "bbf3a383270b716515bfd4a1f44b8c6041ed6129dd7703a2f8cb56a5d75cd6c2"
    end
  end
