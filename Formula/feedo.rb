class Feedo < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "f288c9079d5c102eb9115cde77da6ef0146a6bc45ac4947fe4123aeb0aafc75c"
    end
    on_intel do
      url "https://github.com/ricardodantas/feedo/releases/download/v#{version}/feedo-#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "32c8364015f03badfdc22b9e07331ac141652f2368793e65479781a2d29f7dc5"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "041e056962dd82cf912f9e62db88cc8cb441d90615bd923a8695ef6e740cd403"
    end
    on_intel do
      url "https://github.com/ricardodantas/feedo/releases/download/v#{version}/feedo-#{version}-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "5f1296a7465e97cf6f5c028bfa6ace10a233584a9f41f9daec765075121a3f7c"
    end
  end
