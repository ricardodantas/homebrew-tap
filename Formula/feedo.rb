class Feedo < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "37d57b9f2ca331d1e598f7fc378c887b4f79ce21d6a97aabd4b88111042bdd20"
    end
    on_intel do
      url "https://github.com/ricardodantas/feedo/releases/download/v#{version}/feedo-#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "c40c5fcc2156c46df936160da942af1d97d1a96f39866713d2d2c0b9724c775a"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "94398ecd56f33d95a65aa8b724c8db6cc11c868dab2535b38b68873d68d7a06f"
    end
    on_intel do
      url "https://github.com/ricardodantas/feedo/releases/download/v#{version}/feedo-#{version}-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "67511a11a5fd667cd8569922a2b84df74408052e7ded72dd4d105560bc9a18e4"
    end
  end
