class Feedo < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "4fd722821a0f3e440e7574a4c25524b17c850b884bbf282dd7b15cc49c6787ac"
    end
    on_intel do
      url "https://github.com/ricardodantas/feedo/releases/download/v#{version}/feedo-#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "dff2e114b844f6e4640dc52052285cbfbedecc7de610f1d35763b406b22ed050"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "3c254efacc756ff5a5d3ad2d8d265e1bef8943574859a0ad1323f98cef752778"
    end
    on_intel do
      url "https://github.com/ricardodantas/feedo/releases/download/v#{version}/feedo-#{version}-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "154ac3ee464aa06b8c542bc51ffa6ca310f9e43bdbc3643c4ce705b54312a1b2"
    end
  end
